...
import ee.bytecore.backend.graphql.wishlist.WishlistDataFetcher;
...
@SpringBootTest(
        classes = {WishlistDataFetcher.class, GraphQLConfig.class, LocalDateScalar.class, InstantScalar.class})
