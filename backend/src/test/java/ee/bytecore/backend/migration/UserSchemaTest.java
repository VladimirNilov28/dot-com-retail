...
public class UserSchemaTest {
    ...
    VALUES ('USER', 'testuser', NULL, '2000-01-01')
    """);
    ...
    void emailShouldBeUniqueTest() {
        ...
        jdbc.update(
                """
    INSERT INTO users (role, username, email, date_of_birth)
    VALUES ('USER', 'testuser', 'user@test.com', '2000-01-01')
    """);
    ...
    void quantityLessThanZeroShouldBeRejectedTest() {
        ...
        Executable inputNegativeQuantity =
                () -> jdbc.update("""
    ...
    VALUES (1, 'USER', 'testuser', 'user@test.com', '2000-01-01')
    """);
    ...
    """);
        ...
        Executable addSecondWishlistForSameUser =
                () -> jdbc.update("""
    INSERT INTO wishlists (id, user_id)
    VALUES (2, 1)
    """);
